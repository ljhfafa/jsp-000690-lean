...
- Competition: 52 related records were found in the initial multi-query search; the final exact title/body search returned all 50 matching items, as recorded in the report. Earlier Issue #15 source compiled unchanged under Lean 4.32.0 with `[propext, Quot.sound]` and passed fresh kernel replay. That is a portability check from its advertised Lean 4.24.0, not a reproduction of its original pin. Related [PR #35](https://github.com/TheJustinSunPrize/awards/pull/35) and [Issue #157](https://github.com/TheJustinSunPrize/awards/issues/157) are also disclosed. The [competition report](https://github.com/ljhfafa/jsp-000690-lean/blob/6bf387b9a8ff779090453aaad181170fcd782f43/verification/COMPETITION.md) records evidence and limits.
...
- [Verification report](https://github.com/ljhfafa/jsp-000690-lean/blob/6bf387b9a8ff779090453aaad181170fcd782f43/verification/VERIFICATION_REPORT.md), [correspondence](https://github.com/ljhfafa/jsp-000690-lean/blob/6bf387b9a8ff779090453aaad181170fcd782f43/verification/STATEMENT_CORRESPONDENCE.md), [detailed semantic review](https://github.com/ljhfafa/jsp-000690-lean/blob/6bf387b9a8ff779090453aaad181170fcd782f43/verification/statement-audit.md), and [audit harness](https://github.com/ljhfafa/jsp-000690-lean/blob/6bf387b9a8ff779090453aaad181170fcd782f43/verification/AuditBridge.lean). Report commit B is `6bf387b9a8ff779090453aaad181170fcd782f43`. These reports are later additions describing the immutable proof commit above, not a claim that the later documentation commit was the original proof snapshot.

## Attribution

- **Original mathematics: Ruiliang Li.** No mathematical-solver credit or mathematical discovery is claimed by this submitter.
- **Repository owner ljhfafa:** commissioned and directed the project, authorized publication, and owns the original repository. No manual proof authorship is asserted. Commit metadata uses the owner’s configured local Git identity; the technical work was performed by Codex as disclosed here.
